...
{
	public static class SciterGraphics
	{
		...
		[StructLayout(LayoutKind.Sequential)]
		public struct SciterGraphicsApi
		{
			...
			*/
			...
			public delegate GRAPHIN_RESULT FPTR_vWrapGfx(IntPtr hgfx, out SciterValue.VALUE toValue);

			public delegate GRAPHIN_RESULT FPTR_vWrapImage(IntPtr himg, out SciterValue.VALUE toValue);

			public delegate GRAPHIN_RESULT FPTR_vWrapPath(IntPtr hpath, out SciterValue.VALUE toValue);

			public delegate GRAPHIN_RESULT FPTR_vWrapText(IntPtr htext, out SciterValue.VALUE toValue);

			public delegate GRAPHIN_RESULT FPTR_vUnWrapGfx(ref SciterValue.VALUE fromValue, out IntPtr phgfx);

			public delegate GRAPHIN_RESULT FPTR_vUnWrapImage(ref SciterValue.VALUE fromValue, out IntPtr phimg);

			public delegate GRAPHIN_RESULT FPTR_vUnWrapPath(ref SciterValue.VALUE fromValue, out IntPtr phpath);

			public delegate GRAPHIN_RESULT FPTR_vUnWrapText(ref SciterValue.VALUE fromValue, out IntPtr phtext);
