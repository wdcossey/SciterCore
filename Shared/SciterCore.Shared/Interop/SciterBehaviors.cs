...
namespace SciterCore.Interop
{
	public static class SciterBehaviors
	{
		...
		{
			public SOM_EVENTS cmd; // SOM_EVENTS
			public IntPtr data;
			/*union {
		...
		public enum FOCUS_CMD_TYPE : uint
		{
			FOCUS_RQ_NEXT,
			FOCUS_RQ_PREV,
			FOCUS_RQ_HOME,
		...
		public struct SCRIPTING_METHOD_PARAMS
		{
			...
			public uint argc;
			public SciterValue.VALUE result;	// plz note, Sciter will internally call ValueClear to this VALUE,
		...
		public struct VALUE_PARAMS 
		{
			...
			public SciterValue.VALUE val;// SCITER_VALUE
		}
